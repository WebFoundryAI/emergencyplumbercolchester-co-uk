...
export const PAGE_FAQS: FAQ[] = [
  {
    ...
    answer: 'We aim to respond to <a href="/services/emergency-drain-services/" class="text-primary hover:underline">emergency drainage callouts</a> within 60-90 minutes across <a href="/locations/colchester/" class="text-primary hover:underline">Colchester</a> and Essex. Our team operates around the clock, so help is available whenever you need it, day or night.'
  },
  {
    question: "Do you charge a call-out fee?",
  ...
  },
  {
    ...
    answer: 'We provide drainage services throughout <a href="/locations/colchester/" class="text-primary hover:underline">Colchester</a> and Essex, including <a href="/locations/wivenhoe/" class="text-primary hover:underline">Wivenhoe</a>, <a href="/locations/west-mersea/" class="text-primary hover:underline">West Mersea</a>, <a href="/locations/tiptree/" class="text-primary hover:underline">Tiptree</a>, Witham, Kelvedon, Marks Tey, Brightlingsea, and Manningtree. See <a href="/locations/" class="text-primary hover:underline">all locations we cover</a>.'
  },
  {
