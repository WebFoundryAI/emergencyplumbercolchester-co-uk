...
export const PAGE_FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'We provide drainage services throughout <a href="/locations/glasgow/" class="text-primary hover:underline">Glasgow</a> and the Central Scotland, including <a href="/locations/paisley/" class="text-primary hover:underline">Paisley</a>, <a href="/locations/east-kilbride/" class="text-primary hover:underline">East Kilbride</a>, <a href="/locations/motherwell/" class="text-primary hover:underline">Motherwell</a>, Hamilton, Lanark, Cumbernauld, Coatbridge, and Rutherglen. See <a href="/locations/" class="text-primary hover:underline">all locations we cover</a>.'
  },
  {
